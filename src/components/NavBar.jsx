...
export default function NavBar({ cart, toggle, setToggle, removeFunction, updateQuantity }) {
    ...
    return (
        <>
            ...
            <div onClick={() => setToggle(false)} className={`bg-brightness ${toggle ? "show" : "hide"}`}></div>
            {
                    ...
                    <>
                        ...
                        <div className='cart__view'>
                            <div className="cart-wrapper1">
                                <p className="bold psize-m tt-cart">Cart ({cart.length})</p>
                                <p className="function__remove" onClick={removeFunction}>Remove all</p>
                            </div>
                            {
                                cart.length === 0 ? (
                                    <h1>Cart is empty</h1>
                                            ...
                                            return (
                                                <div className="product-box" key={p.id}>
                                                    <div className="box-img">
                                                        <div className="img__c" style={{ backgroundImage: `url(${p.img})`}}></div>
                                                    </div>
                                                    <div className="wrapper__pricett">
                                                        <p className="product-t psize-s bold">{p.model}</p>
            ...
            <div className="nav">
                ...
                <svg onClick={() => {
                    setToggle(prev => !prev);
                    console.log(toggle)
                }} className='cart-icon' width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
