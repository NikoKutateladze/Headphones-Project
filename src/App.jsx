        ...
        <div className="inner-header">
          <div className="nav">
            ...
            <div className="nav-section">
              ...
              <div className="section earphones">HEADPHONES</div>
              <div className="section speakers">SPEAKERS</div>
              <div className="section headphones">EARPHONES</div>
            </div>
      ...
      <div className="body2">
        ...
        <div className="products-container">
          <div className="product-wrapper">
            <div className="wrapper-content">
              ...
              <div className="img-product ProS1"></div>
            ...
            <div className="wrapper-content">
              <div className="background"></div>
              <div className="img-product ProS2"></div>
              <div className="shadow"></div>
              <p className='wrapper-tt'>HEADPHONES</p>
              <p className='shop'>SHOP <span className='arrow-right'>›</span></p>
            </div>
            <div className="wrapper-content">
              <div className="background"></div>
              <div className="img-product ProS3"></div>
              <div className="shadow"></div>
              <p className='wrapper-tt'>HEADPHONES</p>
              <p className='shop'>SHOP <span className='arrow-right'>›</span></p>
            </div>
        ...
        <div className="products-container">
          ...
          <div className="product-wrapper2">
            <div className="wrapper2-tt">ZX7 SPEAKER</div>
            <div className="wrapper2-btn">SEE PRODUCT</div>
          </div>
          <div className="product-wrapper3">
            <div className="wrapper3-img"></div>
            <div className="wrapper3-container">
              <div className="wrapper3-tt">YX1 EARPHONES</div>
              <div className="wrapper2-btn">SEE PRODUCT</div>
            </div>
          </div>
        </div>
      ...
      <footer>
        <div className="footer-navbar">
          ...
          <div className="footer-section">
            ...
            <p className='footer-nav'>HEADPHONES</p>
            <p className='footer-nav'>SPEAKERS</p>
            <p className='footer-nav'>EARPHONES</p>
          </div>
        </div>
